...
__API_SYMBOL__ dpu_id_t
dpu_get_rank_allocator_id(struct dpu_t *dpu)
{
    return (dpu_id_t)dpu->rank->rank_handler_allocator_id;
}

__API_SYMBOL__ dpu_id_t
dpu_get_rank_allocator_id2(struct dpu_rank_t *rank)
{
    return (dpu_id_t)rank->rank_handler_allocator_id;
}

__API_SYMBOL__ dpu_id_t
dpu_get_nr_dpus_enabled(struct dpu_rank_t *rank)
{
    return (dpu_id_t)rank->nr_dpus_enabled;
}
